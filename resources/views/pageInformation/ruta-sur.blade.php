  ...
  <div class="bg-gray-900 text-white">
    ...
    <section class="relative bg-cover bg-center h-[60vh]" style="background-image: url('https://via.placeholder.com/1920x1080');">
        <div class="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
            <h1 class="text-5xl font-bold text-center">Ruta Sur</h1>
        </div>
    </section>

    <!-- Sección de Información -->
    <section class="container mx-auto py-16 px-6 lg:px-16">
        <h2 class="text-3xl font-bold mb-6 text-indigo-500">Descripción</h2>
        <p class="text-gray-300 leading-relaxed">
            La <span class="font-bold text-white">Ruta Sur</span> conecta las principales zonas del lado Sur de la Ciudad de El Alto con el eje central la Ceja.
    ...
    <div class="container mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
        ...
        <div class="lg:col-span-2">
            <div class="rounded-lg overflow-hidden shadow-lg">
                <iframe 
                    src="https://www.facebook.com/plugins/video.php?height=314&href=https%3A%2F%2Fwww.facebook.com%2FElAltoAlcaldia%2Fvideos%2F691230882925633%2F&show_text=false&width=560&t=0" 
        ...
        <div class="bg-gray-900 p-6 rounded-lg shadow-md space-y-4">
            <h3 class="text-2xl font-bold text-indigo-500">Paradas</h3>
            ...
            <div id="accordion-paradas" data-accordion="collapse">
                ...
                <h2 id="heading-vuelta">
                    <button type="button" 
                        class="flex items-center justify-between w-full p-4 font-medium text-left text-pink-400 bg-gray-800 rounded-lg hover:bg-gray-700" 
                        data-accordion-target="#content-vuelta" 
                        aria-expanded="true" 
                        aria-controls="content-vuelta">
                        Ruta de Vuelta: Ceja → SAMO
                ...
                <div id="content-vuelta" class="hidden" aria-labelledby="heading-vuelta">
                    <ol class="relative border-l border-pink-400 mt-4">
                        <li class="mb-10 ml-4">
                            <div class="absolute w-3 h-3 bg-pink-400 rounded-full -left-1.5 border border-gray-900"></div>
                        ...
                        <li class="ml-4">
                            <div class="absolute w-3 h-3 bg-pink-400 rounded-full -left-1.5 border border-gray-900"></div>
                            <div class="p-4 bg-gray-800 rounded-lg shadow-md">
                                <h3 class="text-lg font-semibold text-white">SAMO - Camino a Oruro</h3>
                ...
                <h2 id="heading-ida">
                    <button type="button" 
                        class="flex items-center justify-between w-full p-4 font-medium text-left text-indigo-600 bg-gray-800 rounded-lg hover:bg-gray-700" 
    ...
    <section class="py-16 px-6 lg:px-16 bg-gray-900">
        <h3 class="text-3xl font-bold text-indigo-500 mb-6">Mapa Interactivo</h3>

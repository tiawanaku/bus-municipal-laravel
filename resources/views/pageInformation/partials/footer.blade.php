  ...
  <div class="container mx-auto px-6 md:px-12">
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
      <div class="flex justify-center md:justify-start">
        <a href="https://www.elalto.gob.bo/?fbclid=IwAR1WNCkKjtTlSDMWUQW0XDH_-B6EkCMdtYv4wkFyk2VitJZTsleye8wAniU" class="flex items-center">
          <img src="img/logoGAMEA.png" alt="GAMEA Logo" class="h-16 sm:h-20 md:h-28 lg:h-32">
        </a>
      </div>
      <div>
